...
<!DOCTYPE html5>
		...
		<div class = "backContainer">
			...
			<div class="game-container">
				...
				<div class="move-container" style="font-size:16pt">
					...
					<form name="myForm" id="button3" onsubmit="return flipCard()">
						...
						<input type="submit" value="Flip Card" class="move-action" style="font-size:16pt;width:3cm">
					</form>
				</div>
	...
	<script type="text/javascript">
		...
		function disableGame() {
			...
			document.getElementById("button3").onsubmit="";
			document.getElementById("newGame").innerHTML='<button type="button" class="move-action" onclick="window.location.href=\'hol.html\';">New Game</button>'
